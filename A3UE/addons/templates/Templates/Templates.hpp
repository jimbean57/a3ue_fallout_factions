class Templates 
{
    ...
    */
    class Vanilla_AAF_New : Vanilla_Base
    {
        ...
        name = "My new faction"; // Name shown in the select menu.
        file = "CustomFaction"; // The template file name - .sqf, that gets appended automatically.
        ...
        description = "This is my custom faction :)"; // If this isn't included, no description will show (unless inherited from the base class.)
    };
